                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button class="close" aria-hidden="true" type="button" data-dismiss="modal"
                                @click="deleteProfileDialogDismiss_Click">&times;
                        </button>
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-default" type="button" data-dismiss="modal"
                                @click="deleteProfileDialogDismiss_Click">Cancel
                        </button>
                        <button class="btn btn-danger" type="button" :disabled="!(deleteNameInput === user.name)"
                                @click="deleteProfile_Click(user._id)">Delete
                        </button>
                    </div>
                </div>
            </div>
